...
- Tab does not fold regions in terminal (tried to fix and couldn't)
- Powerbar is ugly. (Using doom, works in tablet not in phone for some reason, may be the font)
